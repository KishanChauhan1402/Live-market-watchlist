...
export const SimulationToolbar: React.FC<SimulationToolbarProps> = ({
  ...
  return (
    <div className="bg-[#0B111D] border-b border-amber-900/40 px-4 py-3 text-xs">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-3">
        {/* Left title */}
        <div className="flex items-center gap-2">
          <div className="p-1 rounded bg-amber-950/60 border border-amber-800/60 text-amber-400">
          ...
          <div>
            ...
            <span className="text-[11px] text-slate-400 ml-2 hidden sm:inline">
              Simulate dynamic market movements, halts, and ranking shifts
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center flex-wrap gap-2">
          {/* Swap Sector Ranks (Req 9) */}
          <button
            onClick={() => mockProvider.triggerRankSwapITAndBank()}
            className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 transition-colors"
            title="Demonstrates dynamic sector ranking shift: Bank jumps above IT"
          >
            <ArrowUpDown className="w-3 h-3 text-sky-400" />
            <span>Swap Bank &amp; IT Ranks</span>
          </button>
          ...
          >
            ...
            <span>Rally WIPRO (+5.8%)</span>
          </button>

          {/* Trigger Stock Plunge */}
          <button
          ...
          >
            ...
            <span>Plunge DLF (-7.2%)</span>
          </button>

          {/* Toggle Security Halt */}
          <button
          ...
          >
            ...
            <span>Halt / Resume INFY</span>
          </button>

          {/* Simulate Connection Loss & Reconnect (Req 22) */}
          <button
          ...
          >
            <option value="MARKET OPEN">Session: Market Open</option>
            <option value="PRE-MARKET">Session: Pre-Market</option>
            <option value="MARKET CLOSED">Session: Market Closed</option>
            <option value="POST-MARKET">Session: Post-Market</option>
            <option value="DATA UNAVAILABLE">Session: Unavailable</option>
          </select>
